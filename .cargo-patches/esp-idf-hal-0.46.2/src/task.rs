...
#[inline(always)]
#[cfg_attr(target_os = "espidf", link_section = ".iram1.interrupt_task_do_yield")]
pub fn do_yield() {
    if interrupt::active() {
        unsafe {
...
#[inline(always)]
#[cfg_attr(target_os = "espidf", link_section = ".iram1.interrupt_task_current")]
...
#[inline(always)]
#[cfg_attr(target_os = "espidf", link_section = ".iram1.cs_enter")]
...
#[inline(always)]
#[cfg_attr(target_os = "espidf", link_section = ".iram1.cs_exit")]
