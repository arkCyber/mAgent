...
#[inline(always)]
#[cfg_attr(target_os = "espidf", link_section = ".iram1.interrupt_active")]
pub fn active() -> bool {
...
#[allow(clippy::type_complexity)]
#[inline(always)]
#[cfg_attr(target_os = "espidf", link_section = ".iram1.interrupt_get_isr_yielder")]
...
#[allow(clippy::type_complexity)]
#[inline(always)]
#[cfg_attr(target_os = "espidf", link_section = ".iram1.interrupt_set_isr_yielder")]
...
#[cfg(not(any(esp32, esp32s2, esp32s3, esp32p4)))]
#[inline(always)]
#[cfg_attr(target_os = "espidf", link_section = ".iram1.interrupt_enter")]
...
#[cfg(not(any(esp32, esp32s2, esp32s3, esp32p4)))]
#[inline(always)]
#[cfg_attr(target_os = "espidf", link_section = ".iram1.interrupt_exit")]
...
#[inline(always)]
#[cfg_attr(target_os = "espidf", link_section = ".iram1.interrupt_free")]
